...
\date{Octobre 2018\\\includegraphics{Images/uvsq-logo.jpg}}
...
\section{Utilisation}
Une fois que l'on a un programme dans l'éditeur geany, le bouton \raisebox{-1mm}{\includegraphics[height=5mm]{Images/compile.png}} ou bien \texttt{<$\cdot$>} permet de compiler
puis le bouton à sa droite \raisebox{-1mm}{\includegraphics[height=5mm]{Images/execute.png}} ou bien une coche $\checkmark$) permet d'exécuter.
...
\code{ \verbatiminput{Compilation_separee_avec_uvsqgraphics/affiche.h} }

Le fichier \texttt{affiche.c} qui contiennent des fonctions d'affichage qui utilisent la librairie \texttt{uvsqgraphics}:\code{ \verbatiminput{Compilation_separee_avec_uvsqgraphics/affiche.c} }

Le fichier \texttt{principal.c} qui contient la fonction \texttt{main} et qui appelle des fonctions de \texttt{affiche.h}:
\code{ \verbatiminput{Compilation_separee_avec_uvsqgraphics/principal.c} }

Le fichier \texttt{Makefile}:
\code{ \verbatiminput{Compilation_separee_avec_uvsqgraphics/Makefile.sanstab} }
...
{\includegraphics[height=0.6\textheight]{Images/les_couleurs.png}}}
